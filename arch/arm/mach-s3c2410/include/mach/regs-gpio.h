...
#define S3C2410_GPA23_OUTP   (0<<23)
#define S3C2416_GPA23_RSMCLK (1<<23)

#define S3C2410_GPA24_OUTP   (0<<24)
#define S3C2416_GPA24_RSMAVD (1<<24)
...
#define S3C2416_GPBSEL     S3C2410_GPIOREG(0x1C)
...
#define S3C2410_GPM0_OUTP    (0x10 <<0)

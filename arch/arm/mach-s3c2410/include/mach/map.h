...
/* S3C2416 memory and IO controls */
#define S3C2416_PA_SSMC	(0x4F000000)
#define S3C2416_VA_SSMC	S3C_ADDR_CPU(0x00000000)

#define S3C2416_PA_EBI	(0x4E800000)
#define S3C2416_VA_EBI	S3C_ADDR_CPU(0x00100000)

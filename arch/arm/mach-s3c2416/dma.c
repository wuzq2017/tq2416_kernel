...
static struct s3c24xx_dma_map __initdata s3c2416_dma_mappings[] = {
	...
	[DMACH_SDI] = {
		...
		.hw_addr.to	= S3C2410_PA_IIS + S3C2416_IISFIFOTX,//S3C2410_IISFIFO,
		.hw_addr.from	= S3C2410_PA_IIS + S3C2416_IISFIFOTX,//S3C2410_IISFIFO,
	},
	[DMACH_SPI0] = {
		.name		= "spi0",
	...
	[DMACH_I2S_IN] = {
		...
		.hw_addr.from	= S3C2410_PA_IIS + S3C2416_IISFIFORX,//S3C2410_IISFIFO,
	},
	[DMACH_I2S_OUT] = {
		.name		= "i2s-sdo",

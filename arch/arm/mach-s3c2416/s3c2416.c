...
static struct map_desc s3c2416_iodesc[] __initdata = {
	...
	IODESC_ENT(TIMER),
	{
		.virtual = (unsigned long)S3C2416_VA_SSMC,
		.pfn	 = __phys_to_pfn(S3C2416_PA_SSMC),
		.length	 = SZ_1M,
		.type	 = MT_DEVICE,
	},
	{
		.virtual = (unsigned long)S3C2416_VA_EBI,
		.pfn	 = __phys_to_pfn(S3C2416_PA_EBI),
		.length	 = SZ_1M,
		.type	 = MT_DEVICE,
	},
};
...
int __init s3c2416_init(void)
{
	...
	s3c_i2c0_setname("s3c2416-i2c");
	s3c_i2c1_setname("s3c2416-i2c");
...
{
	s3c24xx_init_uartdevs("s3c2416-uart", s3c2410_uart_resources, cfg, no);
